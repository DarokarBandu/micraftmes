...
export default function Testimonial() {
    ...
    // Double items for seamless swiper loop with slidesPerView: 3
        ...
        <>
            <section className="testimonial-section-modern" id="testimonial">
                ...
                <div className="container">
                    ...
                    <Swiper {...swiperOptions} className="testimonial-modern-carousel">
            ...
            :global(.testimonial-swiper-pagination) {
            ...
            :global(.testimonial-swiper-pagination .swiper-pagination-bullet) {
                width: 9px !important;
                height: 9px !important;
                margin: 0 3px !important;
                background: rgba(115, 102, 202, 0.25) !important;
                border-radius: 50% !important;
                opacity: 1 !important;
                transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1) !important;
                cursor: pointer;
            }
            :global(.testimonial-swiper-pagination .swiper-pagination-bullet-active) {
