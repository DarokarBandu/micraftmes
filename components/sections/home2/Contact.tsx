                            ...
                            <ul className="contact-one__list list-unstyled">
                                <li>
                                    ...
                                    <div className="content">
                                        <h4>Location</h4>
                                        <p>603, White Square, Hinjewadi-Wakad Road,<br /> Pune, Maharashtra 411057</p>
                                    </div>
                                </li>
                                <li>
                                    <div className="icon">
                                    ...
                                    <div className="content">
                                        ...
                                        <p><Link href="mailto:support@micraft.co.in">support@micraft.co.in</Link></p>
                                    </div>
                                </li>
                                <li>
                                    <div className="icon">
                                    ...
                                    <div className="content">
                                        <h4>Contact</h4>
                                        <p>Tel: <Link href="tel:+919356865559">+91 93568 65559</Link></p>
                                        <p>Mob: <Link href="tel:+919022476798">+91 90224 76798</Link></p>
                                    </div>
                                </li>
                            </ul>
                        </div>
