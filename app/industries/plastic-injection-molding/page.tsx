...
const industryList = [
    ...
    { name: "Plastic Injection Molding", link: "/industries/plastic-injection-molding", active: true },
...
export default function PlasticInjectionMoldingPage() {
    return (
        <Layout
            ...
            footerStyle={2}
        >
            <Breadcrumb breadcrumbTitle="MES for Plastic Injection Molding" />
                        ...
                        <div className="col-xl-8 col-lg-7">
                            <div className="services-details__right ps-xl-5">
                                ...
                                <p className="services-details__text-1 text-white opacity-70 mb-4 lead">
                                    Micraft MES helps plastic injection molding manufacturers gain real-time visibility of molding cycles, machine utilization, and rejection rates ensuring zero-defect production at scale.
                                </p>
                                ...
                                <div className="services-details__points-box p-5 rounded-5 mt-5" style={{ background: 'rgba(23, 28, 41, 0.4)', border: '1px solid rgba(255, 255, 255, 0.05)' }}>
                                    <AnimatedTitle><h4 className="services-details__title-2 text-white fw-bold mb-4">Injection Molding Challenges</h4></AnimatedTitle>
                                    <p className="services-details__text-3 text-white opacity-70 mb-4">High-volume molding requires precision monitoring to remain profitable. Without it:</p>
                                    <div className="row">
                                        <div className="col-xl-6">
                                            <ul className="services-details__points-list list-unstyled">
                                                {["Difficulty tracking output across multiple machines", "Limited visibility into real machine utilization", "Manual recording of floor production data"].map((item, idx) => (
                                                    <li key={idx}>
                                                        <div className="icon">
                                        ...
                                        <div className="col-xl-6">
                                            <ul className="services-details__points-list list-unstyled">
                                                {["Manual rejection tracking is slow and error-prone", "Unexpected machine downtime slows shipments", "Inaccurate production reporting for management"].map((item, idx) => (
                                                    <li key={idx}>
                                                        <div className="icon">
                                                            <span className="icon-tick-inside-circle text-primary"></span>
                                                        </div>
            ...
            <section className="production-journey responsive-section-padding overflow-hidden" style={{ background: 'var(--techguru-black)', position: 'relative' }}>
                ...
                <div className="container" style={{ position: 'relative', zIndex: 1 }}>
                    <div className="section-title text-center mb-3 pb-2">
                        <AnimatedTitle><h2 className="section-title__title text-white mt-3 display-4 fw-900" style={{ lineHeight: '1.1' }}>Molding Process Logic Roadmap</h2></AnimatedTitle>
                    </div>
                    <div className="horizontal-roadmap-wrapper d-flex flex-column flex-lg-row justify-content-between align-items-center align-items-lg-start gap-5 gap-lg-4 mt-5 pb-5">
                        {[
                            { step: "01", title: "Mold Setup", icon: "fas fa-wrench", desc: "Machine prep & heat validation" },
                            { step: "02", title: "Cycle Start", icon: "fas fa-sync", desc: "Real-time shot tracking & OEE" },
                            { step: "03", title: "Cooling & QC", icon: "fas fa-snowflake", desc: "Post-mold inspection & gating" },
                            { step: "04", title: "Regrind Sort", icon: "fas fa-recycle", desc: "Wastage & runner tracking" },
                            { step: "05", title: "Packing Flow", icon: "fas fa-box-open", desc: "Box-count & final release" }
                        ].map((item, i, arr) => (
                    ...
                    <div className="row">
                        <div className="col-xl-6">
                            <div className="section-title text-start mb-5">
                                <span className="section-title__tagline text-primary uppercase letter-spacing-3 fw-bold">Maximizing Performance</span>
                                <AnimatedTitle>
                                    <h2 className="section-title__title text-white mt-3 display-4 fw-900" style={{ lineHeight: '1.1' }}>
                                        Molding Optimization Data Hub
                                    </h2>
                                </AnimatedTitle>
                            </div>
                        </div>
                        <div className="col-xl-6 d-flex align-items-center">
                            <p className="text-white opacity-70 lead mb-0">Micraft MES provides innovative, data-driven cycle tracking for high-volume molding job shops and enterprise plants.</p>
                        </div>
                    </div>
                                ...
                                <ul className="services-details__points-two list-unstyled">
                                    <li>
                                        ...
                                        <div className="content">
                                            <h5 className="text-white fw-bold">Cycle-time Optimization</h5>
                                            <p className="text-white-50 small">Monitor shot-to-shot consistency and identify micro-deviations in cooling or injection cycles.</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div className="icon">
                                        ...
                                        <div className="content">
                                            <h5 className="text-white fw-bold">Mold Life Tracking</h5>
                                            <p className="text-white-50 small">Digitally count shots per mold to trigger preventive maintenance and prevent flash issues.</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                            <div className="col-xl-6">
                                <ul className="services-details__points-two list-unstyled">
                                    <li>
                                        ...
                                        <div className="content">
                                            <h5 className="text-white fw-bold">Downtime Cause Analysis</h5>
                                            <p className="text-white-50 small">Empower operators to record reason codes for mold changes, material shortages, or hopper issues.</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div className="icon">
                                        ...
                                        <div className="content">
                                            <h5 className="text-white fw-bold">Quality Check Gating</h5>
                                            <p className="text-white-50 small">Implement digital inspection checks at every shift to ensure visual and dimensional accuracy.</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div className="row align-items-center mb-5">
                        <div className="col-lg-7">
                            <div className="section-title text-start mb-0">
                                ...
                                <AnimatedTitle><h2 className="section-title__title text-white mt-3 display-5 fw-900" style={{ lineHeight: '1.1' }}>Maximize Injection Molding ROI</h2></AnimatedTitle>
                            </div>
                        </div>
                        <div className="col-lg-5"><p className="text-white opacity-60 lead mb-0 border-start ps-4 border-primary border-3">Identify downtime reasons and production interruptions instantly to stay at peak molding capacity.</p></div>
                    </div>
                    <div className="row g-4 mt-4">
                        {[
                            { title: "Peak Utilization", desc: "Maximize machine productivity through real-time utilization and automated OEE tracking.", icon: "icon-strategy" },
                            { title: "Machine Visibility", desc: "Track performance across all injection molding machines from a single centralized hub.", icon: "icon-target" },
                            { title: "Cycle Consistency", desc: "Identify and eliminate causes of cycle deviations for 24/7 profitable molding operations.", icon: "icon-check-mark" },
                            { title: "Dynamic Schedule", desc: "Monitor live production output against shift targets to adjust planning in real-time.", icon: "icon-tick-inside-circle" },
                            { title: "Scrap Reduction", desc: "Track rejection rates precisely to optimize mold settings and material regrind usage.", icon: "icon-idea" },
                            { title: "Fulfillment Speed", desc: "Ensure every molding job is completed and packed according to delivery timelines.", icon: "icon-transparency" }
                        ].map((ben, i) => (
            ...
            <section className="segments-section responsive-section-padding" style={{ background: 'var(--techguru-black)' }}>
                <div className="container py-lg-5">
                    <div className="row g-5">
                        <div className="col-lg-6">
                            <div className="segments-box p-5 rounded-5 h-100" style={{ background: 'linear-gradient(145deg, rgba(23,28,41,0.6) 0%, rgba(2,5,10,0.8) 100%)', border: '1px solid rgba(255,255,255,0.05)' }}>
                                <h3 className="text-white fw-bold mb-4">Ideal for Plastic Segments</h3>
                                <ul className="list-unstyled">
                                    {[
                                        "Automotive Plastic Component Mfg",
                                        "Consumer Electronics Housing",
                                        "Medical Grade Clean-room Molding",
                                        "Packaging & FMCG Cap/Closure Mfg",
                                        "Industrial Engineering Plastics",
                                        "Toys & Durable Goods Molding"
                                    ].map((seg, i) => (
                        ...
                        <div className="col-lg-6">
                            <div className="why-box p-5 rounded-5 h-100" style={{ background: 'rgba(61, 114, 252, 0.05)', border: '1px solid rgba(61, 114, 252, 0.2)' }}>
                                <h3 className="text-white fw-bold mb-4">Why Plastic Moulders Choose Us</h3>
                                <p className="text-white-50 mb-4">Molding is about cycles and seconds. We track every shot in real-time.</p>
                                <ul className="list-unstyled">
                                    {[
                                        "Wireless machine-link connectivity",
                                        "Real-time cavity & shot count visibility",
                                        "Automated downtime reason analytics",
                                        "Quality gating with digital check-sheets",
                                        "Scalable from small shops to large plants"
                                    ].map((adv, i) => (
                    ...
                    <div className="clusters-box mt-5 p-5 rounded-5 text-center" style={{ background: 'rgba(255, 255, 255, 0.02)', border: '1px solid rgba(255,255,255,0.05)' }}>
                        <h3 className="text-white fw-bold mb-4">Supporting Major Molding Clusters</h3>
                        <div className="d-flex flex-wrap justify-content-center gap-4">
                            {["Daman & Silvassa Belt", "Ahmedabad Plastic Hub", "Pune Automotive molding", "Chennai Industrial Cluster", "Nashik Engineering Zone"].map((cluster, i) => (
            ...
            <section className="integration-section py-5" style={{ background: '#060A13' }}>
                <div className="container py-lg-5 text-center">
                    <h2 className="text-white fw-900 mb-5">Complete Molding MES Integration</h2>
                    ...
                    <div className="row g-3 justify-content-center">
                        {[
                            { name: "Molding Process Tracking", link: "/solutions/manufacturing-process-tracking" },
                            { name: "Machine Utilization Software", link: "/solutions/machine-utilization-tracking" },
                            { name: "Real-Time Shot Monitoring", link: "/solutions/real-time-production-monitoring" },
                            { name: "Shift Inspection Checks", link: "/solutions/quality-inspection-tracking" },
                            ...
                            <div className="col-lg-10" style={{ position: 'relative', zIndex: 5 }}>
                                <AnimatedTitle>
                                    <h2 className="newsletter-one__title text-white mb-20 fw-900" style={{ fontSize: '42px', lineHeight: '1.1' }}>
                                        Digitize Your Injection Molding Factory
                                    </h2>
                                </AnimatedTitle>
                                <p className="newsletter-one__text text-white mb-40 mx-auto opacity-90" style={{ maxWidth: '750px' }}>
                                    Gain real-time visibility of machine activity, production output, and inspection results.
                                    Schedule a demo to see how Micraft MES fits your molding facility.
                                </p>
                                ...
                                <div className="cta-btns d-flex flex-wrap justify-content-center gap-4">
                                    <Link href="/book-demo" className="thm-btn shadow-2xl" style={{ background: '#0B192C', color: '#fff' }}>
                                        Start Your Molding Pilot <span className="icon-arrow-right"></span>
                                    </Link>
                                    <Link href="/contact" className="thm-btn shadow-2xl" style={{ background: 'transparent', border: '1px solid #fff', color: '#fff' }}>
                                        Consultation for Job Ships <span className="icon-arrow-right"></span>
                                    </Link>
                                </div>
                            </div>
                        </div>
