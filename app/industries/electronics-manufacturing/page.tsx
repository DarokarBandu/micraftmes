...
const industryList = [
    ...
    { name: "Electronics Manufacturing", link: "/industries/electronics-manufacturing", active: true },
...
export default function ElectronicsManufacturingPage() {
    return (
        <Layout
            ...
            footerStyle={2}
        >
            <Breadcrumb breadcrumbTitle="MES for Electronics Manufacturing" />
                            ...
                            <div className="services-details__left">
                                ...
                                <div className="services-details__need-help mt-4">
                                    <div className="services-details__need-help-img rounded-4 overflow-hidden border-primary-glow shadow-2xl">
                                        <Image src="/assets/images/solutions/production-tracking-hero-1775020832743.png" alt="Electronics Assembly" width={356} height={450} style={{ objectFit: 'cover', width: '100%', height: 'auto' }} priority />
                            ...
                            <div className="services-details__right ps-xl-5">
                                ...
                                <AnimatedTitle>
                                    <h1 className="services-details__title-1 text-white fw-900 mb-4" style={{ fontSize: '48px', lineHeight: '1.0' }}>
                                        MES Software for <span style={{ color: '#7366CA', fontFamily: 'var(--techguru-font-two)', fontWeight: '400' }} className="d-block">Electronics Manufacturing</span>
                                    </h1>
                                </AnimatedTitle>
                                <h3 className="h5 text-white opacity-90 mb-4 fw-bold">Monitor production cycles, track assembly operations, and manage quality inspections for high-volume manufacturers.</h3>
                                ...
                                <p className="services-details__text-1 text-white opacity-70 mb-4 lead">
                                    Micraft MES enables electronics manufacturers to gain real-time visibility across multi-stage assembly lines. Track work orders, monitor production output, and manage quality results directly from the floor.
                                </p>
                                <p className="services-details__text-2 text-white-50 extra-small mb-5">
                                    The system supports high-volume high-mix manufacturing environments, providing a digital backbone for modern electronics factory monitoring.
                                </p>
                                ...
                                <div className="services-details__points-box p-5 rounded-5 mt-5" style={{ background: 'rgba(23, 28, 41, 0.4)', border: '1px solid rgba(255, 255, 255, 0.05)' }}>
                                    <AnimatedTitle><h4 className="services-details__title-2 text-white fw-bold mb-4" style={{ lineHeight: '1.1' }}>Core Assembly Challenges</h4></AnimatedTitle>
                                    <p className="services-details__text-3 text-white opacity-70 mb-4">Precision assembly demands live tracking. Without it, factories face:</p>
                                    <div className="row">
                                        <div className="col-xl-6">
                                            <ul className="services-details__points-list list-unstyled">
                                                {["Limited visibility of assembly line progress", "Difficulty tracking specific production batches", "Manual recording of inspection & test results"].map((item, idx) => (
                                                    <li key={idx}>
                                                        <div className="icon">
                                        ...
                                        <div className="col-xl-6">
                                            <ul className="services-details__points-list list-unstyled">
                                                {["Delays in identifying critical quality trends", "Inaccurate or delayed production reporting", "Coordination gaps between assembly stages"].map((item, idx) => (
                                                    <li key={idx}>
                                                        <div className="icon">
                                                            <span className="icon-tick-inside-circle text-primary"></span>
                                                        </div>
            ...
            {/* Production Roadmap for Electronics */}
            <section className="production-journey responsive-section-padding overflow-hidden" style={{ background: 'var(--techguru-black)', position: 'relative' }}>
                ...
                <div className="container" style={{ position: 'relative', zIndex: 1 }}>
                    <div className="section-title text-center mb-3 pb-2">
                        <AnimatedTitle><h2 className="section-title__title text-white mt-3 display-4 fw-900" style={{ lineHeight: '1.1' }}>Electronics Production Logic Roadmap</h2></AnimatedTitle>
                    </div>
                    <div className="horizontal-roadmap-wrapper d-flex flex-column flex-lg-row justify-content-between align-items-center align-items-lg-start gap-5 gap-lg-4 mt-5 pb-5">
                        {[
                            { step: "01", title: "Comp. Kitting", icon: "fas fa-microchip", desc: "Inventory pick & component kitting" },
                            { step: "02", title: "SMT Assembly", icon: "fas fa-robot", desc: "Automated pick & place line" },
                            { step: "03", title: "Optical Insp.", icon: "fas fa-microscope", desc: "AOI and digital test checks" },
                            { step: "04", title: "Final Build", icon: "fas fa-tools", desc: "Through-hole & backend build" },
                            { step: "05", title: "Burn-in & Box", icon: "fas fa-check-double", desc: "Functional test & serial release" }
                        ].map((item, i, arr) => (
                            ...
                            <div className="section-title text-start mb-5">
                                ...
                                <AnimatedTitle>
                                    <h2 className="section-title__title text-white mt-3 display-4 fw-900" style={{ lineHeight: '1.1' }}>
                                        End-to-End Electronics Mfg Hub
                                    </h2>
                                </AnimatedTitle>
                            </div>
                        </div>
                        <div className="col-xl-6 d-flex align-items-center">
                            <p className="text-white opacity-70 lead mb-0">Micraft MES provides high-precision tracking for multi-stage electronics assembly, ensuring full component-level visibility.</p>
                        </div>
                    </div>
                                ...
                                <ul className="services-details__points-two list-unstyled">
                                    <li>
                                        ...
                                        <div className="content">
                                            <h5 className="text-white fw-bold">PCBA Process Tracking</h5>
                                            <p className="text-white-50 small">Monitor every board through kitting, SMT, wave soldering, and manual assembly.</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div className="icon">
                                        ...
                                        <div className="content">
                                            <h5 className="text-white fw-bold">Reel-Level Traceability</h5>
                                            <p className="text-white-50 small">Track component batch codes and reels to specific PCB serial numbers for audits.</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                            <div className="col-xl-6">
                                <ul className="services-details__points-two list-unstyled">
                                    <li>
                                        ...
                                        <div className="content">
                                            <h5 className="text-white fw-bold">Automated AOI Sync</h5>
                                            <p className="text-white-50 small">Integrate inspection data from automated optical inspection machines into live dashboards.</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div className="icon">
                                        ...
                                        <div className="content">
                                            <h5 className="text-white fw-bold">Functional Test Logs</h5>
                                            <p className="text-white-50 small">Digitally record burn-in and functional test results for 100% QA pass verification.</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div className="row align-items-center mb-5">
                        <div className="col-lg-7">
                            <div className="section-title text-start mb-0">
                                ...
                                <AnimatedTitle><h2 className="section-title__title text-white mt-3 display-5 fw-900" style={{ lineHeight: '1.1' }}>Electronics Performance Impact</h2></AnimatedTitle>
                            </div>
                        </div>
                        <div className="col-lg-5"><p className="text-white opacity-60 lead mb-0 border-start ps-4 border-primary border-3">High-fidelity production monitoring for zero-defect electronics manufacturing operations.</p></div>
                    </div>
                    <div className="row g-4 mt-4">
                        {[
                            { title: "Peak Utilization", desc: "Maximize SMT line output through real-time machine activity tracking.", icon: "icon-strategy" },
                            { title: "Rapid QC Pulse", desc: "Digital inspection logs for instantaneous quality-trend responses.", icon: "icon-target" },
                            { title: "Batch Visibility", desc: "Track every production batch from kitting to final boxing with 100% accuracy.", icon: "icon-check-mark" },
                            { title: "Component Traceability", desc: "Ensure compliance with full reel-to-board serialized tracking history.", icon: "icon-tick-inside-circle" },
                            { title: "Verified Data", desc: "Access 100% accurate operational data for management reviews and ISO audits.", icon: "icon-idea" },
                            { title: "JIT Delivery", desc: "Ensure electronic components are dispatched on rigid client timelines with no delays.", icon: "icon-transparency" }
                        ].map((ben, i) => (
            ...
            <section className="segments-section responsive-section-padding" style={{ background: 'var(--techguru-black)' }}>
                <div className="container py-lg-5">
                    <div className="row g-5">
                        <div className="col-lg-6">
                            <div className="segments-box p-5 rounded-5 h-100" style={{ background: 'linear-gradient(145deg, rgba(23,28,41,0.6) 0%, rgba(2,5,10,0.8) 100%)', border: '1px solid rgba(255,255,255,0.05)' }}>
                                <h3 className="text-white fw-bold mb-4">Ideal for Electronics Segments</h3>
                                <ul className="list-unstyled">
                                    {[
                                        "Consumer Electronics Assembly",
                                        "Industrial PCB & System Build",
                                        "Telecom & Network Equipment Mfg",
                                        "Medical Electronics Components",
                                        "EV Electronics & Power Modules",
                                        "LED Graphics & Lighting Mfg"
                                    ].map((seg, i) => (
                        ...
                        <div className="col-lg-6">
                            <div className="why-box p-5 rounded-5 h-100" style={{ background: 'rgba(61, 114, 252, 0.05)', border: '1px solid rgba(61, 114, 252, 0.2)' }}>
                                <h3 className="text-white fw-bold mb-4">Why Electronics Mfg Choose Micraft</h3>
                                <p className="text-white-50 mb-4">High-volume manufacturers need precision without overhead. We provide the digital pulse.</p>
                                <ul className="list-unstyled">
                                    {[
                                        "PCBA level serialized identification",
                                        "Integration with machine test results",
                                        "Real-time yield and reject dashboards",
                                        "Scalable for multi-line factory setups",
                    ...
                    <div className="clusters-box mt-5 p-5 rounded-5 text-center" style={{ background: 'rgba(255, 255, 255, 0.02)', border: '1px solid rgba(255,255,255,0.05)' }}>
                        <h3 className="text-white fw-bold mb-4">Supporting Major Electronics Clusters</h3>
                        <div className="d-flex flex-wrap justify-content-center gap-4">
                            {["Noida & Greater Noida Hub", "Sriperumbudur (Chennai)", "Bangalore Electronics City", "Pune (Hinjewadi) Network", "Hyderabad Hardware Hub"].map((cluster, i) => (
            ...
            <section className="integration-section py-5" style={{ background: '#060A13' }}>
                <div className="container py-lg-5 text-center">
                    <h2 className="text-white fw-900 mb-5">Complete Electronics MES Integration</h2>
                    ...
                    <div className="row g-3 justify-content-center">
                        {[
                            { name: "PCBA Process Tracking", link: "/solutions/manufacturing-process-tracking" },
                            { name: "Machine Intensity Monitoring", link: "/solutions/machine-utilization-tracking" },
                            { name: "Real-Time Production Dashboards", link: "/solutions/real-time-production-monitoring" },
                            { name: "Assembly Quality Tracking", link: "/solutions/quality-inspection-tracking" },
                            ...
                            <div className="col-lg-10" style={{ position: 'relative', zIndex: 5 }}>
                                <AnimatedTitle>
                                    <h2 className="newsletter-one__title text-white mb-20 fw-900" style={{ fontSize: '42px', lineHeight: '1.1' }}>
                                        Digitize Your Electronics Manufacturing Factory
                                    </h2>
                                </AnimatedTitle>
                                <p className="newsletter-one__text text-white mb-40 mx-auto opacity-90" style={{ maxWidth: '750px' }}>
                                    Gain complete visibility of production, inspections, and high-volume assembly operations.
                                    Schedule a demo to see how Micraft MES fits your electronics facility.
                                </p>
                                ...
                                <div className="cta-btns d-flex flex-wrap justify-content-center gap-4">
                                    <Link href="/book-demo" className="thm-btn shadow-2xl" style={{ background: '#0B192C', color: '#fff' }}>
                                        Start Your Electronics Pilot <span className="icon-arrow-right"></span>
                                    </Link>
                                    <Link href="/contact" className="thm-btn shadow-2xl" style={{ background: 'transparent', border: '1px solid #fff', color: '#fff' }}>
                                        Consultation for PCBA Factories <span className="icon-arrow-right"></span>
                                    </Link>
                                </div>
                            </div>
                        </div>
