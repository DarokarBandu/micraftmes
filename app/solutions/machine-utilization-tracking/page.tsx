                            ...
                            <div id="main-content-area" suppressHydrationWarning className="services-details__right mt-0 pt-0 pb-5 pe-xl-5">
                                                ...
                                                <div className="section-title text-left mb-4">
                                                    ...
                                                    <AnimatedTitle>
                                                        <h1 className="section-title__title title-animation mb-4" style={{ lineHeight: '1.0', fontSize: '48px' }}>
                                                            Machine Utilization Tracking <span style={{ color: '#7366CA', fontFamily: 'var(--techguru-font-two)', fontWeight: '400' }}>Software</span>
                                                        </h1>
                                                    </AnimatedTitle>
                                                </div>
                                ...
                                <section id="problems" className="pt-0 pb-4 section-anchor section-fade-in">
                                         <div className="section-title text-left mb-4">
                                            ...
                                            <AnimatedTitle>
                                                <h3 className="section-title__title title-animation responsive-h2" style={{ lineHeight: '1.1' }}>Common <span style={{ color: '#7366CA', fontFamily: 'var(--techguru-font-two)', fontWeight: '400' }}>Machine Productivity</span> Gaps</h3>
                                            </AnimatedTitle>
                                        </div>
                                        ...
                                        <div className="row g-4 mt-2">
                                            {[
                                                ...
                                                { text: "High Setup Times", sub: "Undetected delays in changeovers and machine initialization.", icon: "fas fa-tools", color: "#7366CA", label: "LATENCY" },
                                ...
                                <section id="how-it-works" className="pt-0 pb-4 section-anchor section-fade-in">
                                        <div className="p-4 p-xl-5 rounded-5 shadow-2xl position-relative overflow-hidden" 
                                            ...
                                            <div className="section-title text-center mb-5">
                                                ...
                                                <AnimatedTitle>
                                                    <h3 className="section-title__title title-animation responsive-h2" style={{ lineHeight: '1.1' }}>Automated <span style={{ color: '#7366CA', fontFamily: 'var(--techguru-font-two)', fontWeight: '400' }}>OEE Capture</span> Logic</h3>
                                                </AnimatedTitle>
                                            </div>
                                ...
                                <section id="capabilities" className="pt-0 pb-4 section-anchor section-fade-in">
                                        <div className="section-title text-left mb-5">
                                            ...
                                            <AnimatedTitle>
                                                <h2 className="section-title__title title-animation mb-4" style={{ lineHeight: '1.1' }}>Core <span style={{ color: '#7366CA', fontFamily: 'var(--techguru-font-two)', fontWeight: '400' }}>Utilization Capabilities</span></h2>
                                            </AnimatedTitle>
                                        </div>
                                        <div className="row g-4">
                                            {[
                                ...
                                <section id="benefits" className="pt-0 pb-4 section-anchor section-fade-in">
                                         <div className="p-xl-5 p-4 rounded-5 position-relative overflow-hidden shadow-2xl" style={{ background: 'rgba(7, 11, 20, 0.95)', border: '1px solid rgba(139, 92, 246, 0.2)' }}>
                                             <div className="section-title text-center mb-5">
                                                 ...
                                                 <AnimatedTitle>
                                                     <h2 className="section-title__title title-animation mb-3" style={{ lineHeight: '1.1' }}>Equipment <span style={{ color: '#7366CA', fontFamily: 'var(--techguru-font-two)', fontWeight: '400' }}>Excellence Wins</span></h2>
                                                 </AnimatedTitle>
                                             </div>
