...
export default function ProductionAnalyticsPage() {
  ...
  return (
    <Layout headerStyle={1} footerStyle={2}>
      <Breadcrumb breadcrumbTitle="Production Analytics & Insights" />
            ...
            <div className="col-xl-9 col-lg-10 text-center">
              <div className="section-title text-center mb-4 wow fadeInUp" data-wow-delay="100ms">
                <div className="section-title__tagline-box justify-content-center">
                  ...
                  <span className="section-title__tagline">Intelligence Layer</span>
                  <div className="section-title__tagline-shape-2"></div>
                </div>
                <AnimatedTitle>
                  <h1 className="section-title__title title-animation mb-4" style={{ fontSize: '52px', lineHeight: '1.15' }}>
                    Precision <span>Production Analytics</span> & Insights Hub
                  </h1>
                </AnimatedTitle>
              </div>
              ...
              <p className="wow fadeInUp mx-auto mb-4" data-wow-delay="200ms" style={{ color: 'rgba(255,255,255,0.7)', lineHeight: '1.8', fontSize: '18px', maxWidth: '720px', fontWeight: 500 }}>
                Turn fragmented shop floor data into a strategic operational advantage with real-time performance intelligence and predictive analytics.
              </p>
              ...
              <p className="wow fadeInUp mx-auto mb-5" data-wow-delay="300ms" style={{ color: 'rgba(255,255,255,0.45)', lineHeight: '1.7', fontSize: '15px', maxWidth: '780px' }}>
                Micraft MES transforms raw manufacturing data into meaningful insights through powerful real-time dashboards and performance analytics. Monitor KPIs, analyze operational trends, and make informed decisions to drive continuous improvement in factory performance.
              </p>
              ...
              <div className="d-flex flex-wrap justify-content-center gap-3 wow fadeInUp mb-5 pb-4" data-wow-delay="400ms">
                ...
                <Link href="/features/production-dashboard" className="thm-btn" style={{ background: 'rgba(255,255,255,0.04)', boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.08)' }}>Live Dashboards<span className="icon-right-arrow"></span></Link>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="meswork-nav-inner d-flex align-items-center justify-content-center"
              ...
              <div className="nav-links d-flex align-items-center justify-content-center gap-2 flex-wrap">
                {[
                  ...
                  { id: "step-6-review", label: "Strategic Review", icon: "file-signature", color: "#FA5674" }
                ].map((nav, i) => (
                  <Fragment key={i}>
          ...
          <div className="row justify-content-center mb-5">
            <div className="col-lg-8 text-center">
              <div className="section-title text-center mb-4 wow fadeInUp" data-wow-delay="100ms">
                <div className="section-title__tagline-box justify-content-center">
                  <div className="section-title__tagline-shape-1"></div>
                  <span className="section-title__tagline">Data-Driven Management</span>
                  <div className="section-title__tagline-shape-2"></div>
                </div>
                <AnimatedTitle>
                  <h2 className="section-title__title text-white" style={{ fontSize: '36px' }}>Turn Operational Pulses into <span>Strategic Intelligence</span></h2>
                </AnimatedTitle>
              </div>
              <p className="mx-auto" style={{ color: 'rgba(255,255,255,0.55)', lineHeight: '1.8', fontSize: '16px', maxWidth: '680px' }}>
                Manufacturing operations generate thousands of data points daily. Micraft MES ensures this data is structured, visualized, and ready for immediate management action.
              </p>
            </div>
          </div>
          ...
          <div className="row justify-content-center mb-5">
            <div className="col-lg-8 text-center">
              <div className="section-title text-center mb-4 wow fadeInUp">
                <div className="section-title__tagline-box justify-content-center">
                  <div className="section-title__tagline-shape-1"></div>
                  <span className="section-title__tagline">Data Intelligence Flow</span>
                  <div className="section-title__tagline-shape-2"></div>
                </div>
                <AnimatedTitle>
                  <h2 className="section-title__title text-white" style={{ fontSize: '36px' }}>The 6-Step <span>Continuous Improvement Cycle</span></h2>
                </AnimatedTitle>
              </div>
              <p className="mx-auto" style={{ color: 'rgba(255,255,255,0.5)', fontSize: '16px', maxWidth: '650px', lineHeight: '1.7' }}>
                Micraft MES ensures that raw shop floor pulses are captured and transformed into data-driven evidence for management reviews.
              </p>
            </div>
          </div>
          ...
          <div className="mes-infographic-container position-relative mx-auto mt-5" style={{ maxWidth: '1000px', padding: '20px 0 80px 0' }}>
            ...
            <div className="text-center position-relative w-100 mb-5 wow zoomIn" style={{ zIndex: 10 }}>
              <div className="d-inline-flex flex-column align-items-center justify-content-center mes-timeline-hub" style={{ width: '150px', height: '150px', borderRadius: '50%', background: 'linear-gradient(135deg, #070C14 0%, #1a2a40 100%)', border: '2px solid rgba(61, 114, 252, 0.4)', boxShadow: '0 0 40px rgba(61, 114, 252, 0.3), inset 0 0 20px rgba(61, 114, 252, 0.2)' }}>
                <div className="mb-2">
                  <i className="fas fa-chart-network" style={{ fontSize: '28px', color: '#3D72FC' }}></i>
                </div>
                <h3 className="text-white fw-bold mb-0" style={{ fontSize: '20px', letterSpacing: '1px' }}>Intelligence</h3>
            ...
            {[
              ...
              { title: "Strategic Performance Review", icon: "file-signature", color: "#FA5674", desc: "Conduct monthly management reviews with automated reports based on 100% verified production facts." }
            ].map((step, idx) => {
      ...
      <section className="py-5 position-relative" style={{ background: '#070C14' }}>
        <div className="container py-4 position-relative z-1">
          ...
          {/* FEATURE 1: MULTI-LEVEL DASHBOARDS */}
          <div className="meswork-step-detail mb-5 wow fadeInUp" id="step-3-viz" style={{ borderLeft: '4px solid #FA5674' }}>
            ...
            <div className="row align-items-center g-4">
              <div className="col-lg-7">
                ...
                <AnimatedTitle>
                  <h2 className="section-title__title text-white mb-3" style={{ fontSize: '30px' }}>Comprehensive <span>Insight Dashboards</span></h2>
                </AnimatedTitle>
                <p style={{ color: 'rgba(255,255,255,0.55)', lineHeight: '1.7', marginBottom: '20px' }}>
                  A unified visual command center. View production activity across machines, orders, shifts, and specific operations without manual data aggregation.
                </p>
                <ul className="meswork-checklist mb-4">
                  <li>Actual vs Target output gauges for every workstation</li>
                  <li>Shift-wise performance ranking and efficiency maps</li>
                  <li>Real-time work order completion percentage trackers</li>
                  <li>Automated OEE visualization (Availability, Performance, Quality)</li>
                </ul>
                <Link href="/features/production-dashboard" className="meswork-link" style={{ color: '#FA5674' }}>
                  Live Dashboard Control <i className="icon-right-arrow"></i>
                </Link>
              </div>
              <div className="col-lg-5">
                <div className="meswork-img-card meswork-img-glow p-2">
                  <Image src="/assets/images/features/pa_hero.png" alt="Analytics View" width={440} height={280} className="w-100" style={{ borderRadius: '20px', objectFit: 'cover' }} />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="meswork-step-detail mb-5 wow fadeInUp" id="step-4-trend" style={{ borderLeft: '4px solid #7366CA' }}>
            ...
            <div className="row align-items-center g-4">
              <div className="col-lg-5 order-2 order-lg-1">
                <div className="meswork-img-card meswork-img-glow p-2">
                  <Image src="/assets/images/features/mm_oee_v2.png" alt="Trend Analysis" width={440} height={280} className="w-100" style={{ borderRadius: '20px', objectFit: 'cover' }} />
                </div>
              </div>
              <div className="col-lg-7 order-1 order-lg-2">
                ...
                <p style={{ color: 'rgba(255,255,255,0.55)', lineHeight: '1.7', marginBottom: '20px' }}>
                  Identify patterns that paper reports miss. Analyze how performance fluctuates over days, weeks, or shifts to pinpoint systemic inefficiencies.
                </p>
                <ul className="meswork-checklist mb-4">
                  <li>Multi-week efficiency comparisons across shift groups</li>
                  <li>Correlation analysis between machine uptime and quality defects</li>
        ...
        <div className="container py-5">
          <div className="section-title text-center mb-5 wow fadeInUp">
            <div className="section-title__tagline-box mx-auto">
              <span className="section-title__tagline">Optimization ROI</span>
            </div>
            <AnimatedTitle>
              <h2 className="section-title__title text-white" style={{ fontSize: '36px' }}>The Power of <span>Data-Driven Management</span></h2>
            </AnimatedTitle>
          </div>
              ...
              <div className="col-lg-10" style={{ position: 'relative', zIndex: 5 }}>
                <AnimatedTitle>
                  <h2 className="newsletter-one__title text-white mb-20" style={{ fontSize: '42px', lineHeight: '1.2' }}>
                    Bring Data-Driven <span>Clarity to Your Factory</span>
                  </h2>
                </AnimatedTitle>
                <p className="newsletter-one__text text-white mb-40 mx-auto" style={{ maxWidth: '750px' }}>
                  Stop guessing. Gain the precise, real-time insights you need to improve operational efficiency, identifies bottlenecks, and ensure your factory hits every target.
                </p>
                ...
                <div className="cta-btns d-flex flex-wrap justify-content-center gap-4">
                  <Link href="/contact" className="thm-btn" style={{ background: '#0B192C', color: '#fff' }}>
                    Request Your Strategy Demo <span className="icon-arrow-right"></span>
                  </Link>
                </div>
              </div>
            </div>
