...
export default function ProductionOrderManagementPage() {
  ...
  return (
    <Layout headerStyle={1} footerStyle={2}>
      <Breadcrumb breadcrumbTitle="Production Order Management" />
            ...
            <div className="col-xl-9 col-lg-10 text-center">
              <div className="section-title text-center mb-4 wow fadeInUp" data-wow-delay="100ms">
                <div className="section-title__tagline-box justify-content-center">
                  ...
                  <span className="section-title__tagline">The Digital Order Lifecycle</span>
                  <div className="section-title__tagline-shape-2"></div>
                </div>
                <AnimatedTitle>
                  <h1 className="section-title__title title-animation mb-4" style={{ fontSize: '52px', lineHeight: '1.15' }}>
                    Precision <span>Production Order</span> Management System
                  </h1>
                </AnimatedTitle>
              </div>
              ...
              <p className="wow fadeInUp mx-auto mb-4" data-wow-delay="200ms" style={{ color: 'rgba(255,255,255,0.7)', lineHeight: '1.8', fontSize: '18px', maxWidth: '720px', fontWeight: 500 }}>
                Transform your production orders from static paperwork into dynamic digital workflows that drive factory performance and delivery precision.
              </p>
              ...
              <p className="wow fadeInUp mx-auto mb-5" data-wow-delay="300ms" style={{ color: 'rgba(255,255,255,0.45)', lineHeight: '1.7', fontSize: '15px', maxWidth: '780px' }}>
                Micraft MES provides a centralized hub for managing every stage of a production order. From digital creation and technical breakdown to real-time status tracking and fulfillment, ensure that every job moves through your shop floor with absolute clarity and control.
              </p>
              ...
              <div className="d-flex flex-wrap justify-content-center gap-3 wow fadeInUp mb-5 pb-4" data-wow-delay="400ms">
                ...
                <Link href="/industries" className="thm-btn" style={{ background: 'rgba(255,255,255,0.04)', boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.08)' }}>Target Industries<span className="icon-right-arrow"></span></Link>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="meswork-nav-inner d-flex align-items-center justify-content-center"
              ...
              <div className="nav-links d-flex align-items-center justify-content-center gap-2 flex-wrap">
                {[
                  ...
                  { id: "step-6-closing", label: "Order Fulfillment", icon: "check-double", color: "#FA5674" }
                ].map((nav, i) => (
                  <Fragment key={i}>
          ...
          <div className="row justify-content-center mb-5">
            <div className="col-lg-8 text-center">
              <div className="section-title text-center mb-4 wow fadeInUp" data-wow-delay="100ms">
                <div className="section-title__tagline-box justify-content-center">
                  <div className="section-title__tagline-shape-1"></div>
                  <span className="section-title__tagline">Shop Floor Orchestration</span>
                  <div className="section-title__tagline-shape-2"></div>
                </div>
                <AnimatedTitle>
                  <h2 className="section-title__title text-white" style={{ fontSize: '36px' }}>Digital Control of <span>Production Life-Cycles</span></h2>
                </AnimatedTitle>
              </div>
              <p className="mx-auto" style={{ color: 'rgba(255,255,255,0.55)', lineHeight: '1.8', fontSize: '16px', maxWidth: '680px' }}>
                Micraft MES eliminates manual spreadsheets and paper travelers, providing a unified digital platform to track every production order from creation to fulfillment.
              </p>
            </div>
          </div>
        ...
        <div className="container py-4 position-relative z-1">
          <div className="row justify-content-center mb-5">
            <div className="col-lg-8 text-center">
              <div className="section-title text-center mb-4 wow fadeInUp">
                ...
                <AnimatedTitle>
                  <h2 className="section-title__title text-white" style={{ fontSize: '36px' }}>The 6-Step <span>Order Management Cycle</span></h2>
                </AnimatedTitle>
              </div>
              <p className="mx-auto" style={{ color: 'rgba(255,255,255,0.5)', fontSize: '16px', maxWidth: '650px', lineHeight: '1.7' }}>
                Each production order follows a structured digital path, ensuring that planners, supervisors, and operators are always aligned.
              </p>
            </div>
          </div>
          ...
          <div className="mes-infographic-container position-relative mx-auto mt-5" style={{ maxWidth: '1000px', padding: '20px 0 80px 0' }}>
            ...
            <div className="text-center position-relative w-100 mb-5 wow zoomIn" style={{ zIndex: 10 }}>
              <div className="d-inline-flex flex-column align-items-center justify-content-center mes-timeline-hub" style={{ width: '150px', height: '150px', borderRadius: '50%', background: 'linear-gradient(135deg, #070C14 0%, #1a2a40 100%)', border: '2px solid rgba(61, 114, 252, 0.4)', boxShadow: '0 0 40px rgba(61, 114, 252, 0.3), inset 0 0 20px rgba(61, 114, 252, 0.2)' }}>
                ...
                <h3 className="text-white fw-bold mb-0" style={{ fontSize: '20px', letterSpacing: '1px' }}>Order Hub</h3>
            ...
            {[
              ...
              { title: "Fulfillment & Archiving", icon: "check-double", color: "#FA5674", desc: "Completed orders are verified, archived, and updated for packing and dispatch readiness." }
            ].map((step, idx) => {
          ...
          <style dangerouslySetInnerHTML={{
            __html: `
                        ...
                        /* Centering logic: Square is 110px. To center on the 50% line:
                           Right side items need to shift left by half square width (55px).
                           Left side items need to shift right by half square width (55px).
                        */
      ...
      <section className="py-5 position-relative" style={{ background: '#070C14' }}>
        ...
        <div className="container py-4 position-relative z-1">
          ...
          {/* FEATURE 1: CENTRAL COMMAND */}
          <div className="meswork-step-detail mb-5 wow fadeInUp" id="step-1-creation" style={{ borderLeft: '4px solid #FA5674' }}>
            ...
            <div className="row align-items-center g-4">
              <div className="col-lg-7">
                ...
                <AnimatedTitle>
                  <h2 className="section-title__title text-white mb-3" style={{ fontSize: '30px' }}>The <span>Order Command Center</span></h2>
                </AnimatedTitle>
                <p style={{ color: 'rgba(255,255,255,0.55)', lineHeight: '1.7', marginBottom: '20px' }}>
                  Stop hunting through email threads and paper folders. Micraft MES provides a unified command center for all production orders, whether synced from your ERP or entered manually.
                </p>
                <ul className="meswork-checklist mb-4">
                  <li>Real-time visual status tags (New, In-Progress, On-Hold, Completed)</li>
                  <li>Automated work order generation from product templates</li>
                  <li>Complete technical specification tracking (Materials, Stages, Tools)</li>
                  <li>Bulk order handling with individual job traceability</li>
                </ul>
                <Link href="/solutions/production-tracking-software" className="meswork-link" style={{ color: '#FA5674' }}>
                  Production Tracking Insights <i className="icon-right-arrow"></i>
                </Link>
              </div>
              <div className="col-lg-5">
                <div className="meswork-img-card meswork-img-glow p-2">
                  <Image src="/assets/images/features/production_order_hub.png" alt="Order Hub" width={440} height={280} className="w-100" style={{ borderRadius: '20px', objectFit: 'cover' }} />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="meswork-step-detail mb-5 wow fadeInUp" id="step-3-prioritization" style={{ borderLeft: '4px solid #FFD25D' }}>
            ...
            <div className="row align-items-center g-4">
              <div className="col-lg-5 order-2 order-lg-1">
                <div className="meswork-img-card meswork-img-glow p-2">
                  <Image src="/assets/images/features/pp_board.png" alt="Prioritization Board" width={440} height={280} className="w-100" style={{ borderRadius: '20px', objectFit: 'cover' }} />
                </div>
              </div>
              <div className="col-lg-7 order-1 order-lg-2">
                ...
                <p style={{ color: 'rgba(255,255,255,0.55)', lineHeight: '1.7', marginBottom: '20px' }}>
                  Shop floor priorities change by the hour. Micraft MES gives you the agility to reorder your production queue in seconds, ensuring the most critical jobs always reach the floor first.
                </p>
                <ul className="meswork-checklist mb-4">
                  <li>Drag-and-drop job ranking for instant schedule adjustments</li>
                  <li>Real-time impact analysis on neighboring work orders</li>
          ...
          {/* FEATURE 3: SHOP FLOOR SYNC */}
          <div className="meswork-step-detail mb-5 wow fadeInUp" id="step-5-recording" style={{ borderLeft: '4px solid #6065D4' }}>
            ...
            <div className="row align-items-center g-4">
              <div className="col-lg-7">
                ...
                <AnimatedTitle>
                  <h2 className="section-title__title text-white mb-3" style={{ fontSize: '30px' }}>Real-Time <span>Execution Loops</span></h2>
                </AnimatedTitle>
                <p style={{ color: 'rgba(255,255,255,0.55)', lineHeight: '1.7', marginBottom: '20px' }}>
                  Eliminate the &quot;What&apos;s happening now?&quot; questions. As operators log progress at their stations, technical planners see the update instantly on their command board.
                </p>
                <ul className="meswork-checklist mb-4">
                  <li>Sub-second progress updates from operator workstation terminals</li>
                  <li>Automatic time-tracking per operation and workstation</li>
                  <li>Direct photo and document uploads for job-floor verification</li>
                  <li>Instant alerts for idle orders or blocked workstations</li>
                </ul>
                <Link href="/features/shop-floor-data-collection" className="meswork-link" style={{ color: '#6065D4' }}>
                  Explore Execution Hub <i className="icon-right-arrow"></i>
                </Link>
              </div>
              <div className="col-lg-5">
                <div className="meswork-img-card meswork-img-glow p-2">
                  <Image src="/assets/images/features/sft_progress.png" alt="Execution Updates" width={440} height={280} className="w-100" style={{ borderRadius: '20px', objectFit: 'cover' }} />
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-5" style={{ background: '#070C14' }}>
        <div className="container py-5">
          <div className="section-title text-center mb-5 wow fadeInUp">
            ...
            <AnimatedTitle>
              <h2 className="section-title__title text-white" style={{ fontSize: '36px' }}>The Impact of <span>Digital Order Efficiency</span></h2>
            </AnimatedTitle>
          </div>
      ...
      <section className="py-5" style={{ background: '#0B1320' }}>
        <div className="container">
          <div className="section-title text-center mb-5">
            ...
            <AnimatedTitle>
              <h2 className="section-title__title text-white" style={{ fontSize: '32px' }}>Related <span>Order Management Features</span></h2>
            </AnimatedTitle>
          </div>
              ...
              <div className="col-lg-10" style={{ position: 'relative', zIndex: 5 }}>
                <AnimatedTitle>
                  <h2 className="newsletter-one__title text-white mb-20" style={{ fontSize: '42px', lineHeight: '1.2' }}>
                    Achieve Zero-Gap <span>Order Orchestration</span>
                  </h2>
                </AnimatedTitle>
                <p className="newsletter-one__text text-white mb-40 mx-auto" style={{ maxWidth: '750px' }}>
                  Stop the paperwork chaos. Experience how Micraft MES transforms your production order management into a precision-engineered operational advantage.
                </p>
