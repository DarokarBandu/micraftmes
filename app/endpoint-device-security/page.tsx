                    ...
                    <div className="row">
                        <div className="col-xl-4 col-lg-5">
                            <div className="services-details__left">
                                <div className="services-details__services-list-box">
                                    <AnimatedTitle>
                                        <h3 className="services-details__services-list-title title-animation">More Services</h3>
                                    </AnimatedTitle>
                                ...
                                <div className="services-details__need-help">
                                    <div className="services-details__need-help-img">
                                        ...
                                        <div className="services-details__need-help-content">
                                            ...
                                            <AnimatedTitle>
                                                <h3 className="services-details__need-help-title title-animation">Need Help?</h3>
                                            </AnimatedTitle>
                        ...
                        <div className="col-xl-8 col-lg-7">
                            <div className="services-details__right">
                                <AnimatedTitle>
                                    <h3 className="services-details__title-1 title-animation">Innovative Strategies for Online Branding and Content
                                        Marketing</h3>
                                </AnimatedTitle>
                                ...
                                <AnimatedTitle>
                                    <h4 className="services-details__title-2 title-animation">Services Core Features</h4>
                                </AnimatedTitle>
                                ...
                                <AnimatedTitle>
                                    <h4 className="services-details__title-3 title-animation">Your Partner in Digital Success</h4>
                                </AnimatedTitle>
                                ...
                                <AnimatedTitle>
                                    <h4 className="services-details__title-4 title-animation">Get Started</h4>
                                </AnimatedTitle>
