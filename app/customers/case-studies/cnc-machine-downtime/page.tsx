...
export default function CNCDowntimeCaseStudy() {
    return (
        <Layout headerStyle={1} footerStyle={2}>
            <Breadcrumb breadcrumbTitle="Case Study: CNC Downtime" />
                    ...
                    <div className="row g-5">
                        <div className="col-lg-8">
                            <div className="cs-content rounded-5 bg-glass-dark border border-white-05 p-4 p-md-5">
                                <span className="tagline-glow mb-3">CNC Machining</span>
                                <h1 className="text-white display-5 fw-black mb-4">Reducing Machine Downtime in a CNC Machine Shop</h1>
                                ...
                                <div className="cs-image-hero mb-60 rounded-5 overflow-hidden border border-white-05 shadow-2xl" style={{ height: '450px', position: 'relative' }}>
                                    <Image src="/assets/images/project/cnc-downtime.png" alt="CNC Monitoring" fill className="img-cover grayscale" />
                                </div>
                                ...
                                <div className="cs-section mb-60">
                                    ...
                                    <p className="text-white-opacity-70 fs-5 leading-relaxed">
                                        Frequent machine stoppages were not properly tracked, resulting in lost production time and poor machine utilization. Without real data, the management couldn&apos;t identify whether issues were technical, material-related, or operator-driven.
                                    </p>
                                </div>
                                ...
                                <div className="cs-section mb-60">
                                    ...
                                    <p className="text-white-opacity-70 fs-5 leading-relaxed">
                                        Micraft MES machine monitoring and OEE tracking were implemented to capture machine status and downtime reasons in real time directly from the shop floor.
                                    </p>
                                    <ul className="list-unstyled mt-4 space-y-3">
                                        {["Real-time OEE tracking", "Automated downtime reason capture", "Live performance dashboards"].map((item, i) => (
                                ...
                                <div className="cs-section">
                                    ...
                                    <div className="row g-4">
                                        {[
                                            { t: "Uptime", d: "Significantly reduced unplanned machine downtime." },
                                            { t: "Insights", d: "Better visibility into fundamental downtime causes." },
                                            { t: "ROI", d: "Improved machine utilization and overall factory productivity." }
                                        ].map((item, i) => (
                                ...
                                <div className="p-4 rounded-5 bg-dark-alt border border-white-05 shadow-xl mb-4">
                                    ...
                                    <ul className="list-unstyled space-y-4">
                                        <li className="d-flex justify-content-between border-bottom border-white-05 pb-3 text-white">
                                            ...
                                            <span className="fw-bold small">CNC Machining</span>
                                        </li>
                                        <li className="d-flex justify-content-between border-bottom border-white-05 pb-3 text-white">
                                            <span className="text-white-50 small">KPI Fixed</span>
                                            <span className="fw-bold small">OEE & Downtime</span>
                                        </li>
                                    ...
                                    <Link href="/book-demo" className="thm-btn w-100 text-center mt-4">Fix Your Downtime</Link>
                                </div>

                                <div className="p-4 rounded-5 bg-glass-dark border border-white-05">
                                    <h5 className="text-white mb-3 fw-bold">Other Success Stories</h5>
                                    <div className="space-y-4">
                                        <Link href="/customers/case-studies/engineering-visibility" className="d-block text-white-50 small hover-text-accent transition-3s border-bottom border-white-05 pb-3 mb-3">Engineering Factory Visibility</Link>
